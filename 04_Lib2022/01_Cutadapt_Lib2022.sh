...
# Parameters
INDIR='00_FASTQ_Lib2022'
OUTDIR='01_Cutadapt_Lib2022/FASTQ_trim'
LOGFILE='01_Cutadapt_Lib2022/process.log'
STATSFILE='01_Cutadapt_Lib2022/summary.tsv'
