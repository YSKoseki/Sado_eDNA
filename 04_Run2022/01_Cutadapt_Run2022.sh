...
# Parameters
INDIR='00_FASTQ_Run2022'
OUTDIR='01_Cutadapt_Run2022/FASTQ_trim'
LOGFILE='01_Cutadapt_Run2022/process.log'
STATSFILE='01_Cutadapt_Run2022/summary.tsv'
