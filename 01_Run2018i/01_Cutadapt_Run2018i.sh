...
# Parameters
INDIR='00_FASTQ_Run2018i'
OUTDIR='01_Cutadapt_Run2018i/FASTQ_trim'
LOGFILE='01_Cutadapt_Run2018i/process.log'
STATSFILE='01_Cutadapt_Run2018i/summary.tsv'
