...
path_asvtab <- "02_DADA2_Lib2019/05_saved_rds/ASV_tab.rds"
## Summary table of the Cutadapt-DADA2 processing
path_sumtab <- "02_DADA2_Lib2019/05_saved_rds/summary_tab.rds"
## ASV sequence data 
path_asvfa <- "02_DADA2_Lib2019/05_saved_rds/ASV_fa.rds"
## Output directory
path_out <- "03_gmmDenoise_Lib2019"
