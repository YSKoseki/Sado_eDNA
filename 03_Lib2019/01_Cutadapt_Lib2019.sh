...
# Parameters
INDIR='00_FASTQ_Lib2019'
OUTDIR='01_Cutadapt_Lib2019/FASTQ_trim'
LOGFILE='01_Cutadapt_Lib2019/process.log'
STATSFILE='01_Cutadapt_Lib2019/summary.tsv'
