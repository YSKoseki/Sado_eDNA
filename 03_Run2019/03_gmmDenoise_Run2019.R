...
# Paths for:
## ASV table
path_asvtab <- "02_DADA2_Run2019/05_saved_rds/ASV_tab.rds"
## Summary table of the preceding Cutadapt–DADA2 pipeline
path_sumtab <- "02_DADA2_Run2019/05_saved_rds/summary_tab.rds"
## Output directory
path_out <- "03_gmmDenoise_Run2019"
