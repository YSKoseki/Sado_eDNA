...
# Parameters
INDIR='00_FASTQ_Run2019'
OUTDIR='01_Cutadapt_Run2019/FASTQ_trim'
LOGFILE='01_Cutadapt_Run2019/process.log'
STATSFILE='01_Cutadapt_Run2019/summary.tsv'
