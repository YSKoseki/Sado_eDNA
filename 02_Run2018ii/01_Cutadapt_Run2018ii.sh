#!/bin/bash
#
# 01_Cutadapt_Lib2018ii.sh
# Shell script to remove MiFish PCR primer pairs from MiSeq paired-end reads
# Reference: https://cutadapt.readthedocs.io/en/stable/guide.html
# cutadapt 5.0

# Parameters
INDIR='00_FASTQ_Run2018ii'
OUTDIR='01_Cutadapt_Run2018ii/FASTQ_trim'
LOGFILE='01_Cutadapt_Run2018ii/process.log'
STATSFILE='01_Cutadapt_Run2018ii/summary.tsv'
